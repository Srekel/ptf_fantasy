...
var techniques = {
    ...
    "The Follow-up": {description: "Attack with -1D6. Resolve another 50% attack effect."},
    "The Omnislash": {description: "Attack with -XD6. Resolve a 50% attack effect on X more targets."},
    "The Piercer": {description: "Attack with -1D6. Pierce +2."},
    "The Safe One": {description: "Attack with +1D6. Can't use with other techniques."},
    ...
    "The Shank": {description: "Attack with Daggers with -1D6. Resolve attack effect again."},
...
var social_talents = {
    ...
    Blackmail: {description: "Threaten NPC with exposing secret.",
             states: [{req: "Threatened", res: "Fear"}, {req: "Fear", res: "Believe"}]},
    Grab: {description: "Get a firm grip on NPC.",
             states: [{req: "Indifferent", res: "Uncomfortable"}, {req: "Uncomfortable", res: "Threatened"}]},
    ...
    Wink: {description: "Subtly hint something at NPC.",
             states: [{req: "Indifferent", res: "Like"}, {req: "Indifferent", res: "Uncomfortable"}, 
                {req: "Like", res: "Trust"},
    ...
    Belittle: {description: "Make NPC feel inferior.",
             states: [{req: "Uncomfortable", res: "Threatened"}, {req: "Indifferent", res: "Uncomfortable"}]},
    Interrupt: {description: "Talk over NPC.",
             states: [{req: "Like", res: "Submissive"}, {req: "Indifferent", res: "Uncomfortable"}]},
    ...
    Insult: {description: "Say something bad about NPC.",
             states: [{req: "Respect", res: "Submissive"}, {req: "Dislike", res: "Threatened"},
                {req: "Indifferent", res: "Uncomfortable"}]},
    ...
    "Small Talk": {description: "Act interested in NPC.",
             states: [{req: "Indifferent", res: "Like"}, {req: "Uncomfortable", res: "Indifferent"}]},
    Joke: {description: "Make NPC laugh.",
             states: [{req: "Indifferent", res: "Like"}, {req: "Like", res: "Trust"},
                {req: "Dislike", res: "Indifferent"}]},
    "Step Back": {description: "Create some space.",
             states: [{req: "Indifferent", res: "Like"}, {req: "Uncomfortable", res: "Indifferent"},
                    {req: "Threatened", res: "Uncomfortable"}, {req: "Fear", res: "Threatened"}]},
    Obstruct: {description: "Stand in the way of NPC's vision.",
             states: []},
    Realign: {description: "Move up to 180 degrees around NPC.",
             states: []},
    "Eye Contact": {description: "NPC keeps eye contact with you.",
             states: []},
    "Grab Attention": {description: "NPC concentrates on you.",
             states: []},
}
